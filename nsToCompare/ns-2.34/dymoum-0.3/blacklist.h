...
/////////////////////////////////////Definition de la table black list for blackHole/////////////////////////////////////////////
typedef struct BlackHoleblacklist
{
	dlist_head_t	list_head;
	struct in_addr	addr;
} BlackHoleblacklist_t;
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////Fin -Add a new entry to the list for black hole///////////////////////////////
void BlackHoleblacklist_add(struct in_addr addr);
bool BlackHoleblacklist_find(struct in_addr addr);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
